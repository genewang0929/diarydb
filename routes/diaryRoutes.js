...
router.post('/user/:email/:folderName', diaryController.postIsDuplicate, diaryController.postDiary);

//PUT specific diary by title in specific folder by folderName
router.put('/user/:email/:folderName/:title', diaryController.putIsDuplicate, diaryController.putDiaryByTitle);
