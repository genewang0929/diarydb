...
//POST folder
router.post('/user/:email/folder', folderController.postIsDuplicate, folderController.postFolder);

//PUT specific folder by folderName
router.put('/user/:email/:folderName', folderController.putIsDuplicate, folderController.putFolder);
